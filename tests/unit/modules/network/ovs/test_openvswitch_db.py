...
from ansible_collections.openvswitch.openvswitch.plugins.modules import openvswitch_db
from ansible_collections.openvswitch.openvswitch.tests.unit.compat.mock import patch, MagicMock
